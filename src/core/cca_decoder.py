...
Lancer la validation :
    python src/core/cca_decoder.py
"""
...
# Permet `from config import ...` en script (`python src/core/cca_decoder.py`) ou en import.
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
from core.config import (BANDPASS, FS_UNICORN, MARGIN, N_HARMONICS, RHO_MIN, Z_MARGIN,  # noqa: E402
