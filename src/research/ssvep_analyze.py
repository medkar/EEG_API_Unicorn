...
et surtout TRÈS bruitées — comparer les configurations entre elles, jamais lire un chiffre absolu.
    ...
    python src/research/ssvep_analyze.py                     # dernier run archivé
    python src/research/ssvep_analyze.py --file data/ssvep_guided_20260720-151733.npz
"""
...
def _latest():
    files = sorted(glob.glob(os.path.join(DATA_DIR, "ssvep_guided_*.npz")))
