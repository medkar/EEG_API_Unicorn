...
réellement émises.
    ...
    python src/research/calibrate.py                       # lit data/session1_2026-07-17.log
    python src/research/calibrate.py chemin/vers/mon.log
"""
...
if __name__ == "__main__":
    ...
    from core.config import DATA_DIR, use_utf8_console
    default = os.path.join(DATA_DIR, "session1_2026-07-17.log")
    use_utf8_console()
