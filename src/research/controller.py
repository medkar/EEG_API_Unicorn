...
Lancer la simulation :
    python src/research/controller.py
"""
...
# Imports internes : marche en script (`python src/research/controller.py`) ou en import.
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))      # -> src/
from core.config import (EXAMPLES_DIR, FS_UNICORN, MARGIN, MIN_VOTES, RHO_MIN,  # noqa: E402
                    UDP_HOST, UDP_PORT, VOTE_LEN, WINDOW_S, apply_invert,
                    choose_frequencies, use_utf8_console)
from core.cca_decoder import CCADecoder, synth_ssvep  # noqa: E402
