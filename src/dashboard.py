...
⚠️ Le stimulus reste NATIF (`src/ssvep_stimulus.py`) : un navigateur ne garantit pas le
...
Lancer :
    python src/dashboard.py --synthetic       # sans casque
    python src/dashboard.py --mode ssvep --refresh 60
    python src/dashboard.py --host 0.0.0.0    # suivi depuis un autre poste
    python src/dashboard.py --smoke           # test headless de bout en bout (CI)
"""
...
from config import use_utf8_console  # noqa: E402
from server import EngineServer  # noqa: E402
