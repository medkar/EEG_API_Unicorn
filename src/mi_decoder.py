...
Validé ici sur ERD SYNTHÉTIQUE (pas de casque).   python src/mi_decoder.py
"""
...
from config import MI_METHOD, MI_REREF, use_utf8_console  # noqa: E402
...
def _demo():
    ...
    # données RÉELLES via `python src/mi_compare.py`. -> ici on teste le classifieur en re-ref 'none'.
