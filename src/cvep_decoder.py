...
calibration et le pilotage DOIVENT utiliser la même chaîne d'alignement.
    ...
    python src/cvep_decoder.py     # validation sur c-VEP synthétique (aucun casque)
"""
...
from config import (CVEP_BAND, CVEP_CHANNELS, CVEP_CORR_MIN,  # noqa: E402
                    CVEP_DECISION_CYCLES, CVEP_MARGIN, CVEP_MODEL_PATH, FS_UNICORN,
                    use_utf8_console)
from cvep_code import build_targets, m_sequence  # noqa: E402
