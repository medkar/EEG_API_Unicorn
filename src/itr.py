...
Deux usages, dans une démarche d'exploration :
  - `python src/itr.py`            compare les 3 modes tels qu'ils sont mesurés aujourd'hui ;
  - `python src/itr.py --scale`    montre comment l'ITR évolue avec le NOMBRE DE CIBLES, ce qui
