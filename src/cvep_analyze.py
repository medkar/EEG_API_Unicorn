...
distribution réelle des corrélations (les valeurs par défaut sont issues du synthétique).
    ...
    python src/cvep_analyze.py
    python src/cvep_analyze.py --file data/cvep_calib_last.npz --max-offset 60
"""
...
from config import CVEP_BAND, use_utf8_console  # noqa: E402
from cvep_decoder import CVEPModel, bandpass  # noqa: E402
from itr import itr as _itr  # noqa: E402

DEFAULT_FILE = os.path.join(_ROOT, "data", "cvep_calib_last.npz")
