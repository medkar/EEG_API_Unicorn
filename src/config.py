...
_ROOT = _os.path.dirname(_os.path.dirname(_os.path.abspath(__file__)))  # racine du projet
...
# après chaque calibration avec `python src/mi_compare.py`.
MI_METHOD = "csp"
...
MI_MODEL_PATH = _os.path.join(_ROOT, "data", "mi_model.joblib")   # modèle entraîné (calibration)
...
CVEP_MIN_VOTES = 2
CVEP_MODEL_PATH = _os.path.join(_ROOT, "data", "cvep_model.npz")
...
CVEP_RCCA_MODEL_PATH = _os.path.join(_ROOT, "data", "cvep_rcca_model.npz")
...
P300_MODEL_PATH = _os.path.join(_ROOT, "data", "p300_model.joblib")
...
ERRP_MODEL_PATH = _os.path.join(_ROOT, "data", "errp_model.joblib")
