...
(recommence le tour pour plus d'essais), puis ESC. C'est l'ordre par défaut ci-dessous.
    ...
    python src/p300_analyze.py
    python src/p300_analyze.py --order AVANT,ARRIERE,AVANT,...   # si tu as visé un autre ordre
    python src/p300_analyze.py chemin/vers.npz
"""
...
from config import P300_MODEL_PATH, p300_targets, use_utf8_console  # noqa: E402
from p300_decoder import P300Model  # noqa: E402

RING = [c["name"] for c in p300_targets()]     # ordre horaire depuis le haut (= ordre à viser)
DATA = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                    "data", "p300_live_last.npz")
