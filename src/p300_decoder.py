...
Validé ici sur P300 SYNTHÉTIQUE (pas de casque).   python src/p300_decoder.py
"""
...
from config import (P300_BAND, P300_EPOCH_S, P300_PRE_S, P300_XDAWN_NFILTER,  # noqa: E402
                    use_utf8_console)
